  ...
  runApp(
    MaterialApp(
      debugShowCheckedModeBanner:
          false, // Ocultar la etiqueta de "debug" en la esquina superior derecha.
      home: Focus(
        autofocus:
            true, // Habilitar el enfoque automático para recibir eventos de teclado.
        child: GameWidget<AshCapturaPikachu>.controlled(
          gameFactory: () =>
              gameInstance, // Proporcionar la instancia del juego al widget.
                ...
                child: Container(
                  ...
                  child: Column(
                    mainAxisSize: MainAxisSize
                        .min, // Ajustar el tamaño de la columna al contenido.
                    children: [
                      const Text(
                        '¡Bienvenido!',
                        style: TextStyle(
                          ...
                          color:
                              Colors.blueAccent, // Estilo de texto llamativo.
                        ),
                      ),
                      const SizedBox(
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ...
                          if (game.isLoaded) {
                            ...
                            game.overlays.remove(
                                'MenuInicio'); // Ocultar el menú de inicio.
                          }
                        },
                        ...
                        child: const Text(
                          'Iniciar Juego',
                          style: TextStyle(
                              fontSize: 20), // Estilo del texto en el botón.
                        ),
                      ),
                    ],
                  ),
          ...
          errorBuilder: (context, ex) => Center(
            child: Text(
                'Error: ${ex.toString()}'), // Muestra el mensaje de error en pantalla.
          ),
